...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load('/fast/rsna-breast/checkpoints/wholeClassifier/different-sweep-6/epoch=26-step=35604.ckpt')['state_dict'])
    print('loaded!')
    ...
    preds = trainer.predict(model=model, dataloaders=valLoader)
    print(preds)
